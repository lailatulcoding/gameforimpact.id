...
<head>
	...
	<script type="text/javascript" src="/js/pages/datatables_advanced.js"></script>
	<!-- /theme JS files -->
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="/admin"><img src="/images/logo_light.png" alt=""></a>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
                                <?php $act = Request::segment(2);?>
								<!-- Main -->
								<li class="<?php echo $act==''? 'active': '';?>"><a href="/admin"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
								<li class="<?php echo $act=='informasi'? 'active': '';?>"><a href="/admin/informasi"><i class="icon-info22"></i> Informasi</a></li>
							    <li class="<?php echo $act=='proposal'? 'active': '';?>"><a href="/admin/proposal"><i class="icon-profile"></i> Proposal</a></li>
								<li class="<?php echo $act=='kontak'? 'active': '';?>"><a href="/admin/kontak"><i class="icon-vcard"></i> Kontak</a></li>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><span class="text-semibold"><?php echo $act==''? 'HOME': strtoupper($act);?></span></h4>
						</div>
